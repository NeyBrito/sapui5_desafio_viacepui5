		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Via Cep AppUI5",
									"targetURL": "#treinaui5sapui5viacep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinaui5sapui5viacep-display": {
								"semanticObject": "treinaui5sapui5viacep",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinaui5.sapui5viacep",
									"url": sap.ui.require.toUrl("treinaui5/sapui5viacep")
								}
							}
						}
					}
